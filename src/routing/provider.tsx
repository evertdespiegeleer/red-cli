...
import { RouteTypes } from './route-types/index'
...
export function RouteProvider(props: { children: React.ReactNode, baseRoute: RouteInstance }) {
    const [route, _setRoute] = useState<RouteInstance>(props.baseRoute)
    const [previousRoute, setPreviousRoute] = useState<RouteInstance | undefined>()
